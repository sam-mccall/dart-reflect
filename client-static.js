...
HashMapImplementation.prototype._grow = function(newCapacity) {
  _assert(HashMapImplementation._isPowerOfTwo(newCapacity), "_isPowerOfTwo(newCapacity)", "/Users/sammccall/dart-sdk/lib/coreimpl/frog/hash_map_set.dart", (148), (12));
  var capacity = this._keys.get$length();
...
$dynamic("query").HTMLDocument = function(selectors) {
  if (const$0006.hasMatch(selectors)) {
...
TokenizerBase.prototype._finishOpenBrace = function() {
  ...
  if (this._interpStack != null) {
    if (this._interpStack.depth == (-1)) {
      ...
      _assert(this._interpStack.depth >= (0), "_interpStack.depth >= 0", "/Users/sammccall/dart-sdk/lib/frog/tokenizer.dart", (314), (16));
...
TokenizerBase.prototype._finishCloseBrace = function() {
  ...
  if (this._interpStack != null) {
    ($0 = this._interpStack).depth = $0.depth - (1);
    _assert(this._interpStack.depth >= (0), "_interpStack.depth >= 0", "/Users/sammccall/dart-sdk/lib/frog/tokenizer.dart", (324), (14));
  }
...
var const$0004 = new JSSyntaxRegExp("^\\[name=[\"'][^'\"]+['\"]\\]$");
var const$0005 = new JSSyntaxRegExp("^[*a-zA-Z0-9]+$");
var const$0006 = new JSSyntaxRegExp("^#[_a-zA-Z]\\w*$");
var $globals = {};
$static_init();
