...
build() {
  buildlib "dart_reflect" 
}

doc() {
  $DART_SDK/bin/dart $DART_SDK/lib/dartdoc/dartdoc.dart --mode=static lib/reflect.dart
  rm -r docs/{dart_core,dart_coreimpl,dart-ext_dart_reflect}{,.html} 2>/dev/null
  cp docs/reflect.html docs/index.html
}
